...
<script src="{{asset('backend/js/dataTables.keyTable.min.js')}}"></script>
<script src="{{asset('backend/js/dataTables.select.min.js')}}"></script>
<script src="{{asset('backend/js/summernote-bs4.min.js')}}"></script>
<script src="{{asset('backend/js/fullcalendar.min.js')}}"></script>
<script src="{{asset('backend/js/demo.summernote.js')}}"></script>
<script src="{{asset('backend/js/dropzone.js')}}"></script>
<script src="{{asset('backend/js/demo.dashboard.js')}}"></script>
<script src="{{asset('backend/js/datatable-initializer.js')}}"></script>
<script src="{{asset('backend/js/fontawesome-iconpicker.min.js')}}" charset="utf-8"></script>
<script src="{{asset('backend/js/bootstrap-tagsinput.min.js')}}" charset="utf-8"></script>
<script src="{{asset('backend/js/bootstrap-tagsinput2.min.js')}}"></script>
<script src="{{asset('backend/js/dropzone.min.js')}}" charset="utf-8"></script>
<script src="{{asset('backend/js/component.fileupload.js')}}" charset="utf-8"></script>
<script src="{{asset('backend/js/demo.form-wizard.js')}}"></script>
<!-- dragula js-->
<script src="{{asset('backend/js/dragula.min.js')}}"></script>
<!-- component js -->
<script src="{{asset('backend/js/component.dragula.js')}}"></script>
...
function showAjaxModal(url, header)
{
    ...
    jQuery('#scrollable-modal .modal-body').html('<div style="text-align:center;"><img src="https://demo.creativeitem.com/academy/assets/global/bg-pattern-light.svg" /></div>');
...
{
    // SHOWING AJAX PRELOADER IMAGE
    jQuery('#large-modal .modal-body').html('<div style="text-align:center;margin-top:200px;"><img src="https://demo.creativeitem.com/academy/assets/global/bg-pattern-light.svg" height = "50px" /></div>');
