        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                    ...
                    <div class="row row-paddingless" style="padding-left: 15px; padding-right: 15px;">
                        ...
                        <div class="col-6 p-0 border-bottom">
                            <a href="/Course/create" class="d-block text-center py-3 bg-hover-light" >
                                ...
                                <a href="/Student/create" class="d-block text-center py-3 bg-hover-light" >
                            ...
                            <div class="col-6 p-0">
                                <a href="/Enroll/create" class="d-block text-center py-3 bg-hover-light" >
            ...
            <li class="dropdown notification-list">
                ...
                <span class="account-user-avatar">
                    <img src="{{asset('backend/image/placeholder.png')}}" alt="user-image" class="rounded-circle">
                </span>
...
@endif
            ...
            <!-- Account -->
            <a href="/Chat" class="dropdown-item notify-item">
