  ...
  <div class="container-fluid course_container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 course_header_col">
        ...
        <a href="/course-detail/{{$course->id}}" class="course_btn">Lessons details <i class="fa fa-chevron-right"></i></a>
      </div>
          ...
          <section style="display: none;">
            ...
            <form action="#" method="get">
                ...
                <label>Stretching (Video Only)<select name="stretching">
                        <option value="responsive" selected>Auto (default)</option>
                    </select>
                    </label>
            </form>
        </section>
          @if ($course->video_file != null)
        ...
        <div class="row" style="margin: 12px -1px">
          <div class="col-12">
            <ul class="nav nav-tabs" id="lessonTab" role="tablist">
              ...
              <li class="nav-item">
                @foreach (App\Models\Lesson::where('course_id',$course->id)->paginate(1) as $lesson)
                <a class="nav-link" style="background-color: rgba(229,9,20,.8);color: white;font-weight: bold;"  href="/lesson/{{$lesson->id}}" role="tab" aria-controls="listening" aria-selected="true">Start Exercise</a>
                @endforeach
              </li>
                    ...
                    <div id="collapse-52" class="collapse show" aria-labelledby="heading-52" data-parent="#accordionExample">
                      <div class="card-body" style="padding:0px;">
                        <table style="width: 100%;">
                          ...
                          <tr style="width: 100%; padding: 5px 0px;background-color: rgb(235, 235, 235);">
