    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document" tabindex="">
      <div class="modal-content" tabindex="">
        ...
        <div class="modal-body ml-2 mr-2" tabindex="" data-select2-id="121">
          ...
          <form action="{{URL::to('lessonstore')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
              ...
              <select class="form-control select2 select2-hidden-accessible" data-toggle="select2" id="selfile" onchange="selectfile()"  data-select2-id="147" tabindex="-1" aria-hidden="true">
            ...
            {{-- <div class="form-group">
              ...
              <input type="url" id="video_url" name="web_url" class="form-control"  placeholder="This video will be shown on web application">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" data-toggle="timepicker" data-minute-step="5" name="mob_duration" id="html5_duration_for_mobile_application" data-show-meridian="false" value="00:00:00">
            </div>
...
function selectfile(){
  var sel = document.getElementById("selfile").value;
