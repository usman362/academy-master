    ...
    <div class="content">
      ...
      <div class="row ">
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> Student add </h4>
            </div> <!-- end card body-->
          </div> <!-- end card -->
        </div><!-- end col-->
      </div>
        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="required-form" action="{{URL::to('Student',$students->id)}}" enctype="multipart/form-data" method="post">
                @csrf
                @method('PUT')
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                              <input type="text" class="form-control" id="first_name" value="{{$students->name}}" name="name" required="">
                            </div>
                          </div>
                          <div class="form-group row mb-3">
                            <label class="col-md-3 col-form-label" for="last_name">Last name<span class="required">*</span></label>
                            <div class="col-md-9">
                              <input type="text" class="form-control" id="last_name"  value="{{$students->lname}}" name="lname" required="">
                            </div>
                          </div>
                          <div class="form-group row mb-3">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                              <input type="email" id="email" name="email"  value="{{$students->email}}" class="form-control" required="">
                            </div>
                          </div>
                          <div class="form-group row mb-3">
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                              <input type="text" id="facebook_link"  value="{{$students->facebook}}" name="facebook" class="form-control">
                            </div>
                          </div>
                          <div class="form-group row mb-3">
                            <label class="col-md-3 col-form-label" for="twitter_link">Twitter</label>
                            <div class="col-md-9">
                              <input type="text" id="twitter_link"  value="{{$students->twitter}}" name="twitter" class="form-control">
                            </div>
                          </div>
                          <div class="form-group row mb-3">
                            <label class="col-md-3 col-form-label" for="linkedin_link">Linkedin</label>
                            <div class="col-md-9">
                              <input type="text" id="linkedin_link"  value="{{$students->linkedin}}" name="linkedin" class="form-control">
                            </div>
                          </div>
                        </div> <!-- end col -->
                      </div> <!-- end row -->
