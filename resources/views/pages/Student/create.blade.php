        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-body">
              ...
              <form class="required-form" action="{{URL::to('Student')}}" enctype="multipart/form-data" method="post">
                @csrf
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="form-group row mb-3">
                            ...
                            <div class="col-md-9">
                              <input type="text" id="facebook_link" name="facebook" class="form-control">
                            </div>
                          </div>
                          <div class="form-group row mb-3">
                            <label class="col-md-3 col-form-label" for="twitter_link">Twitter</label>
                            <div class="col-md-9">
                              <input type="text" id="twitter_link" name="twitter" class="form-control">
                            </div>
                          </div>
                          <div class="form-group row mb-3">
                            <label class="col-md-3 col-form-label" for="linkedin_link">Linkedin</label>
                            <div class="col-md-9">
                              <input type="text" id="linkedin_link" name="linkedin" class="form-control">
                            </div>
                          </div>
                        </div> <!-- end col -->
                      </div> <!-- end row -->
